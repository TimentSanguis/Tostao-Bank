                    ...
                    <div class="trans-info">
                      <div class="container">
                        <div class="warning">
                          <p>
                            <span
                              >Por razões de segurança, você tem a opção de desativar temporariamente o seu cartão.
                              Durante o período de desativação, seu cartão ficará inutilizável.</span
                            >
                          </p>
                          <p id="status">
                            <span> Status atual: </span>
                            <span id="activespan" style="color: green"
                              >Ativo</span
                            >
                          </p>
                        </div>
                        ...
                        <div class="tools-column">
                          <div class="option" id="copy-card">
                            <div class="container">
                              <div class="logo">
                                <img
                                  src="../resources/files/pics/copy.svg" alt=""/>
                              </div>
